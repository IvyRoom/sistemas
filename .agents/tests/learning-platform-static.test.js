...
test("[ASSET-01] platform tracked bytes, paths, Unicode, and digest remain exact", () => {
  ...
  assert.deepEqual(
    treeStats(records),
    {
      files: 182,
      bytes: 20733789,
      digest: "0333d5dbcc1f5ddba1c4ff1c3e2d8ba0c67ffe2da7e39e1db81743471713fd3a"
    },
  ...
  assert.deepEqual(
    ...
    }))),
    {
      files: 182,
      bytes: 20733789,
      digest: "fa04af9f72dec1b4de95d4c035bb6d2c4d133fe2a2f32302ba527cc7cc46b690"
    },
...
test("[ARTIFACT-01] current frontend artifact identity remains exact", () => {
  ...
  assert.deepEqual(
    treeStats(records),
    {
      files: 257,
      bytes: 27338824,
      digest: "eda33a3cbe9abb4799bade46342b07b9b116e1d68c70d2bd83947ff792a0f439"
    },
