...
const Aviso_Carregando_Informações = document.getElementById("Aviso_Carregando_Informações");
const Container_Externo_Conteúdo = document.getElementById("Container_Externo_Conteúdo");
    ...
    if (window.innerWidth <= 1024) { window.location.href = "/plataforma_v2/aviso-dispositivo" }
        ...
        fetch(URL_Base_Backend + '/statusreport', {
            ...
            .then(data => {
                ...
                ////////////////////////////////////////////////////////////////////////////////////////
                // Configura a visualização das informações.

                Container_Externo_Conteúdo.style.display = "block";
                Aviso_Carregando_Informações.style.display = "none";
