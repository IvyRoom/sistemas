...
var BotãoTelaCheiaVídeoDepoimento1 = document.getElementById("Botão-Tela-Cheia-Vídeo-Depoimento-1");
var TextoTelaCheiaVídeoDepoimento1 = document.getElementById("Texto-Tela-Cheia-Vídeo-Depoimento-1");

var ContainerVídeoDepoimento2 = document.getElementById("Container-Vídeo-Depoimento-2");
var VídeoDepoimento2 = document.getElementById("Vídeo-Depoimento-2");
var BotãoTelaCheiaVídeoDepoimento2 = document.getElementById("Botão-Tela-Cheia-Vídeo-Depoimento-2");
var TextoTelaCheiaVídeoDepoimento2 = document.getElementById("Texto-Tela-Cheia-Vídeo-Depoimento-2");

var ContainerVídeoDepoimento3 = document.getElementById("Container-Vídeo-Depoimento-3");
var VídeoDepoimento3 = document.getElementById("Vídeo-Depoimento-3");
var BotãoTelaCheiaVídeoDepoimento3 = document.getElementById("Botão-Tela-Cheia-Vídeo-Depoimento-3");
var TextoTelaCheiaVídeoDepoimento3 = document.getElementById("Texto-Tela-Cheia-Vídeo-Depoimento-3");

var ContainerVídeoDepoimento4 = document.getElementById("Container-Vídeo-Depoimento-4");
var VídeoDepoimento4 = document.getElementById("Vídeo-Depoimento-4");
var BotãoTelaCheiaVídeoDepoimento4 = document.getElementById("Botão-Tela-Cheia-Vídeo-Depoimento-4");
var TextoTelaCheiaVídeoDepoimento4 = document.getElementById("Texto-Tela-Cheia-Vídeo-Depoimento-4");

var ContainerVídeoDepoimento5 = document.getElementById("Container-Vídeo-Depoimento-5");
var VídeoDepoimento5 = document.getElementById("Vídeo-Depoimento-5");
var BotãoTelaCheiaVídeoDepoimento5 = document.getElementById("Botão-Tela-Cheia-Vídeo-Depoimento-5");
var TextoTelaCheiaVídeoDepoimento5 = document.getElementById("Texto-Tela-Cheia-Vídeo-Depoimento-5");

var SetaFechamentoSubseção43 = document.getElementById("Seta-Fechamento-Subseção-4.3");

var SubseçãoCadastro4 = document.getElementById("Subseção-Cadastro-4");
